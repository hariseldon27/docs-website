...
<Callout variant="critcal">
 The Synthetics REST API only supports monitor creation for legacy synthetics runtime versions. Please use [NerdGraph APIs](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial/) to manage your synthetic monitors using our latest runtimes.
</Callout>
...
Our synthetics REST API is one way to manage your legacy synthetic monitors via API but the recommended way is using [our NerdGraph API](/docs/apis/nerdgraph/examples/nerdgraph-synthetics-tutorial).
